...
public class climberTraverseBackward extends CommandBase {

  private final climberTraverseSubsystem m_climberTraverseSubsystem;

  public climberTraverseBackward(climberTraverseSubsystem subsystem) {
  ...
  @Override
  public void execute() {
    climberTraverseSubsystem.climberTraverseMotor.set(-0.5);
  }
